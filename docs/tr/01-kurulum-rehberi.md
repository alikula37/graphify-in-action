...
> bu projede tek bir sorgu **1.694 token** alt graf döndürürken, ajanın aynı soruyu graphify
> olmadan yanıtlamak için okuyacağı dosyalar **9.636–16.842 token** (%82–90 azalma — ölçüldü).
